    ...
    <div className="w-full font-sans md:px-10 " ref={containerRef}>
      ...
      <div ref={ref} className="relative max-w-7xl mx-auto pb-20">
        ...
        <div
          ...
          className="absolute md:left-8 left-8 top-0 overflow-hidden w-[2px] bg-[linear-gradient(to_bottom,var(--tw-gradient-stops))] from-transparent from-[0%] via-light dark:via-dark to-transparent to-[99%]  [mask-image:linear-gradient(to_bottom,transparent_0%,black_10%,black_90%,transparent_100%)] "
        >
          <motion.div
            style={{
            ...
            className="absolute inset-x-0 top-0 h-full w-[2px] bg-gradient-to-t from-primary via-analogous to-accent from-[15%] via-[30%] rounded-full"
          />
        </div>
      </div>
    </div>
